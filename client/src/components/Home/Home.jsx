  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="flex flex-col-reverse md:flex-row flex-wrap xl:flex-nowrap md:px-48 justify-center">
        <div className="z-50 mx-auto flex justify-center md:justify-left px-[5%] md:pt-[15%] w-full md:w-[45%] flex-col content-center align-center text-center xl:text-left">
