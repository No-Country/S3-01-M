    ...
    <div className="flex flex-wrap w-full ">
        <div className="w-full  py-4">
            <div className="relative flex flex-col min-w-0 break-words bg-white rounded-lg mb-6 xl:mb-0 shadow-lg border border-black">
                ...
                <p className="text-sm text-blueGray-500 mt-4 font-semibold"><span className="text-emerald-500 mr-2"> 3.48%</span><span className="whitespace-nowrap">Desde el mes pasado</span></p>
                </div>
            </div>
        </div>
    </div>
