            ...
            <td className="py-2 whitespace-nowrap">
                ...
                <td className="p-2 whitespace-nowrap">
                    <div className="flex items-center">
                        <input type='text' className="font-medium text-gray-800 bg-transparent max-w-[90px]" defaultValue={name} disabled={isDisabled} ref={nameRef}/> 
                    </div>
                </td>
                <td className="p-2 whitespace-nowrap">
                    {
                        description? 
                        (<input type="text" className="text-left max-w-[90px] bg-transparent" defaultValue={description} disabled={isDisabled} ref={descriptionRef}/>): 
                        (<input type="text" className="text-center pr-12 max-w-[90px] bg-transparent" defaultValue='-' disabled={isDisabled} ref={descriptionRef}/>) 
                    }
                </td>
                <td className="p-2 whitespace-nowrap">
                    {
                        movement.movement.incomeCategory? 
                        (<input type="number" className="text-left font-medium text-green-500 max-w-[90px] bg-transparent" defaultValue={amount} disabled={isDisabled} ref={expenseRef}/>):
                        (<input type="number" className="text-left font-medium text-red-500 max-w-[90px] bg-transparent" defaultValue={amount} disabled={isDisabled} ref={expenseRef}/>)
                    }
                    
                </td>
                <td className="p-2 whitespace-nowrap">
                    <input type="date" className="text-md text-right max-w-[120px] bg-transparent" defaultValue={date} disabled={isDisabled} ref={dateRef}/>
                </td>
                <td className="py-2 whitespace-nowrap">
                    <div className="flex items-center justify-center">
                    {
