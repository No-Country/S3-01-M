...
const CardMidEstadistic = () => {
  ...
  const groups = outcomes.slice().sort((a,b)=>a.date.localeCompare(b.date)).reduce((groups, item) => {
  ...
  return (
    <div className="bg-white mx-auto rounded-md text-slate-50 shadow-md shadow-indigo-500/50 w-full">
      <h2 className="text-2xl text-white bg-[#5146ED] w-full text-center py-2">Gastos</h2>
