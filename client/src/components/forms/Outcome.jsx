...
const Outcome = () => {
  ...
  //Esto se va con Formik
  const handleOutcomes = e=> setAmount(e.target.value)

  const handleCategory = e=> setCategory(e.target.value)

  const handleOutcomeName = e=> setName(e.target.value)
...
// ------------------------
  ...
  const submitOutcomes = (e)=>{
      e.preventDefault;
      const id= nanoid()
      dispatch(addMovement({id,amount:-amount, category, name:name, date, description, type:'outcome'}))
  }
  return (
    <>
          {/* Título */}
          ...
          <form className="flex flex-col justify-center">
              <div className="flex justify-between items-center mb-3">
                ...
                <div className="flex">
                    ...
                    <input  id="outcomes" placeholder='0' name="outcomes" type="number" onChange={handleOutcomes} className="max-w-[100px] font-bold font-mono py-1.5 px-2 mx-1.5
              ...
              <input onChange={handleOutcomeName} className="mb-3 px-2 py-1.5
                ...
                {/* Fecha gasto */}
                  ...
                  focus:ring-1
                  focus:ring-sky-500
                  focus:invalid:border-red-500 focus:invalid:ring-red-500" type="date" name="outcomeDate" placeholder="Fecha"/>
                {/* Descripción gasto */}
          ...
          {/* ----------Termina formulario---------- */}
          {/* Botón agregar */}
          <button onClick={submitOutcomes} className="w-full px-4 py-1.5 rounded-md shadow-lg bg-gradient-to-r from-green-400 to-green-600 font-medium text-gray-100 block transition duration-300">
